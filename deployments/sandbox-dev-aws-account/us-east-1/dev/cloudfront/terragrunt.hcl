...
comment = "ACDP CloudFront for the project ${local.common_vars.project_name}, ${local.environment_vars.locals.environment} environment and for account #${get_aws_account_id()}"
